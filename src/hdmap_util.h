...
inline std::string EndWayPointFile() {
  if (FLAGS_use_navigation_mode) {
    ...
    return FLAGS_map_dir + "/" + FLAGS_end_way_point_filename;
  }
}
...
inline std::string DefaultRoutingFile() {
    return FLAGS_map_dir + "_" + FLAGS_default_routing_filename;
}
...
inline std::string ParkGoRoutingFile() {
    return FLAGS_map_dir + "_" + FLAGS_park_go_routing_filename;
}
